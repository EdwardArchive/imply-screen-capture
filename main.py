    ...
    try:
        ...
        capture = DashboardCapture(
            ...
            config={
                ...
                'headless': True  # 리눅스 서버용으로 항상 headless
            }
        )
        ...
        if len(url_list) == 1:
            ...
            result = capture.capture_dashboard_sync(url_list[0])
            print(f"\nCapture result:")
            if result['success']:
            ...
            results = capture.capture_multiple_dashboards_sync(url_list)
